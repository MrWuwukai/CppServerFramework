...
namespace Framework {
    ...
    public:
        ...
        static Address::ptr LookupAny(const std::string& host, int family = AF_UNSPEC, int type = 0, int protocol = 0); // 获取一个地址
        static std::shared_ptr<IPAddress> LookupAnyIPAddress(const std::string& host, int family = AF_UNSPEC, int type = 0, int protocol = 0); // 获取一个地址
